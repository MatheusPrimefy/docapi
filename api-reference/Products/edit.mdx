---
title: 'Edit product'
openapi: POST 'https://api.premepay.com/stores/:id/products/:id'
---
...
| `shippable`        | boolean                                | Physical product or not                                                  | No       |
...
| `description`      | string                                 | Brief description of the Product image                                   | No       |
 ...
 > 💡 Important: This endpoint only updates Product data and adds new images. For an image already registered, it is necessary to delete it and upload the new desired image. Learn more at  [DELETE - Delete product image](https://www.notion.so/DELETE-Delete-product-image-831da094ad5c4b9585138f82f31ef7d8?pvs=21).



 > 💡 Detail: You can associate up to 5 images per Product.
