...
>
  <img src="https://www.notion.so/icons/light-bulb_red.svg" alt="https://www.notion.so/icons/light-bulb_red.svg" width="40px" /> **Business type users** have access to all the Stores associated with a Business, while **Store type users** have access only to the Store they are associated with.
